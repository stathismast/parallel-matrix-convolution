...
int main(int argc, char *argv[]) {
	...
	MPI_Send_init(&myArray[0][0],3,MPI_UNSIGNED_CHAR,myNeighbors.leftUp.rank,0,MPI_COMM_WORLD,&myNeighbors.leftUp.sendRequest);
	...
	MPI_Send_init(&myArray[(rowsNumber/sqrt_comm_sz)-1][0],3,MPI_UNSIGNED_CHAR,myNeighbors.leftDown.rank,0,MPI_COMM_WORLD,&myNeighbors.leftDown.sendRequest);

	/* Send my rightUpCorn to my rightup process */
	MPI_Send_init(&myArray[0][3*(colsNumber/sqrt_comm_sz)-3],3,MPI_UNSIGNED_CHAR,myNeighbors.rightUp.rank,0,MPI_COMM_WORLD,&myNeighbors.rightUp.sendRequest);

	/* Send my rightCol to my right process */
	MPI_Send_init(&myArray[0][3*(colsNumber/sqrt_comm_sz)-3],1,column,myNeighbors.right.rank,0,MPI_COMM_WORLD,&myNeighbors.right.sendRequest);

	/* Send my rightDownCorn to my rightdown process */
	MPI_Send_init(&myArray[(rowsNumber/sqrt_comm_sz)-1][3*(colsNumber/sqrt_comm_sz)-3],3,MPI_UNSIGNED_CHAR,myNeighbors.rightDown.rank,0,MPI_COMM_WORLD,&myNeighbors.rightDown.sendRequest);
	...
	MPI_Recv_init(leftUpCorn,3,MPI_UNSIGNED_CHAR,myNeighbors.leftUp.rank,0,MPI_COMM_WORLD, &myNeighbors.leftUp.recieveRequest);

	/* Recieve leftCol from my left process */
	MPI_Recv_init(leftCol,3*(rowsNumber/sqrt_comm_sz),MPI_UNSIGNED_CHAR,myNeighbors.left.rank,0,MPI_COMM_WORLD, &myNeighbors.left.recieveRequest);
	...
	MPI_Recv_init(leftDownCorn,3,MPI_UNSIGNED_CHAR,myNeighbors.leftDown.rank,0,MPI_COMM_WORLD, &myNeighbors.leftDown.recieveRequest);

	/* Recieve rightUpCorn from my rightup rocess */
	MPI_Recv_init(rightUpCorn,3,MPI_UNSIGNED_CHAR,myNeighbors.rightUp.rank,0,MPI_COMM_WORLD, &myNeighbors.rightUp.recieveRequest);

	/* Recieve rightCol from my right process */
	MPI_Recv_init(rightCol,3*(rowsNumber/sqrt_comm_sz),MPI_UNSIGNED_CHAR,myNeighbors.right.rank,0,MPI_COMM_WORLD, &myNeighbors.right.recieveRequest);

	/* Recieve rightDownCorn from my rightdown process */
	MPI_Recv_init(rightDownCorn,3,MPI_UNSIGNED_CHAR,myNeighbors.rightDown.rank,0,MPI_COMM_WORLD, &myNeighbors.rightDown.recieveRequest);
